...
#              "09adeda0fc76320c3f915549bb166b1753774638f34a1599087c9f102736491e7b4964b1f1572f30bad320b640c425d74d10f03f10b0d11cf480e40c2de2b49b"}]

#MOCK_USERS = [{'email': 'test@example.com', 'salt': '8Fb23mMNHD5Zb8pr2qWA3PE9bH0=', 'hashed': '09adeda0fc76320c3f915549bb166b1753774638f34a1599087c9f102736491e7b4964b1f1572f30bad320b640c425d74d10f03f10b0d11cf480e40c2de2b49b'}]

#bhb7JZN99itt+n7wfRVLwZzWZi0=
...
class MockDBHelper:
	...
	def add_request(self, table_id, time):
		...
		MOCK_REQUESTS.append({'_id': table_id, 'table_number': table_id,
	...
	def delete_request(self, reqest_id):
		for i, request in enumerate(MOCK_REQUESTS):
			if request.get('_id') == reqest_id:
				del MOCK_REQUESTS[i]
				break